...
class PublicationController extends Controller
{
    ...
    {
        $publication = DB::table('publication')->paginate(10); // Change get() to paginate()
        return view('publications.list',compact('publication'));
    }
    ...
    {
        $publications = DB::table('publication')->where('id', $id)->first();
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return response()->json(['status' => 1, 'message' => __('Publication deleted successfully.!') ], 200);
        } catch (\Exception $e) {
